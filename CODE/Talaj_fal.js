function Talaj_fal() {
  ...
  this.p_kcs = loadImage("kcs.png");
  this.p_kozcs = loadImage("kozcs.png");
  this.p_ncs = loadImage("ncs.png");
  this.p_kerd = loadImage("kerd.png");
  this.p_t = loadImage("t.png");
  this.p_l = loadImage("l.png");
  this.p_padlo = loadImage("padlo.png");
  this.p_kerdu = loadImage("kerd_utve.png");
  this.p_kerds = loadImage("kerd_s.png");
  this.ptt = loadImage("tt.png");
