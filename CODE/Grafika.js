function Grafika() {
  ...
  this.p_kf = loadImage("kf.png");
  this.p_kozf = loadImage("kozf.png");
  this.p_nf = loadImage("nf.png");
  this.p_kdb = loadImage("kdb.png");
  this.p_ndb = loadImage("ndb.png");
  this.p_kb = loadImage("kb.png");
  this.p_kozb = loadImage("kozb.png");
  this.p_nb = loadImage("nb.png");
  this.penz = loadImage("money_1.png");
  ...
  this.kfmegjelenites = function() {
    ...
    text(nf(this.pont, 6, 0), this.pontx - 22, 80);
