function Jatekos() {
  ...
  this.kep = [];
  this.kep[0] = loadImage("km_0.png");
  this.kep[1] = loadImage("km_1.png");
  this.kep[2] = loadImage("km_2.png");
  this.kep[3] = loadImage("km_3.png");
  this.kep[4] = loadImage("km_4.png");
  this.kep[5] = loadImage("km_5.png");
  this.kep[6] = loadImage("nm_0.png");
  this.kep[7] = loadImage("nm_1.png");
  this.kep[8] = loadImage("nm_2.png");
  this.kep[9] = loadImage("nm_3.png");
  this.kep[10] = loadImage("nm_4.png");
  this.kep[11] = loadImage("nm_5.png");
  this.kep[12] = loadImage("nm_6.png");
  this.kep[13] = loadImage("kmb_0.png");
  this.kep[14] = loadImage("kmb_1.png");
  this.kep[15] = loadImage("kmb_2.png");
  this.kep[16] = loadImage("kmb_3.png");
  this.kep[17] = loadImage("kmb_3.png");
  this.kep[18] = loadImage("kmb_5.png");
  this.kep[19] = loadImage("nmb_0.png");
  this.kep[20] = loadImage("nmb_1.png");
  this.kep[21] = loadImage("nmb_2.png");
  this.kep[22] = loadImage("nmb_3.png");
  this.kep[23] = loadImage("nmb_4.png");
  this.kep[24] = loadImage("nmb_5.png");
  this.kep[25] = loadImage("nmb_6.png");
  this.kep[26] = loadImage("mh.png");
